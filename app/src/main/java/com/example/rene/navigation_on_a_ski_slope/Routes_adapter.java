...
public class Routes_adapter extends ArrayAdapter<Routes> {
    View customView;

    public Routes_adapter(Context context,Routes[] objects) {
    ...
    customView = inflater.inflate(R.layout.routs_costum_list, parent, false); //

    Routes singleRoute = getItem(position);                                  //filling routes custom list
