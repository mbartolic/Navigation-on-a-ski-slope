...
public class Routs extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Routes_object routs4 = new Routes_object("Kranjska gora",300,250,855);
        Routes_object routs5 = new Routes_object("Bormio",150,250,455);
        Routes_object routs6 = new Routes_object("Flachau",150,250,455);
        Routes_object routs7 = new Routes_object("Val-d'isere",150,250,455);
        Routes_object routs8 = new Routes_object("Rogla",150,250,455);
        Routes_object routs9 = new Routes_object("Savognin",150,250,455);
        Routes_object routs10 = new Routes_object("Kitubuhel",150,250,455);
